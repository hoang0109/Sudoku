...
public class Game extends Activity {
	...
	private int puzzle_old[] = new int[9 * 9] ; 
	public int[][] mypuzzle = new int[9][9];
	public int[][] mypuzzle_changer = new int[9][9];
	...
	protected String getTileString_old(int x, int y) {
		int v = getTile_old(puzzle_old,x, y);
		if (v == 0)
			return "";
		else
			return String.valueOf(v);
